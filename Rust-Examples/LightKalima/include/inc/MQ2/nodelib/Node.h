...
#include "../../KalimaCUtil/opensslUtil.h"
 ...
 * @param config_input Config file full path
 * @param contract_list Pointer to contract_list
 * @param ParamMac To get MacAddr on Apple
 * @return Pointer to Node
 */
Node *create_Node(char *config_input, void *contract_list, char ParamMac[MACAddr_size]);
Node *create_Node_IOS(void *contract_list, char *devID, unsigned char *pubkey, int pcount, unsigned char *prvkey, int pvcount, bool empty, char *LedgerName, char *NODE_NAME, char *Privachain, char *SerialID);
#endif
/**
