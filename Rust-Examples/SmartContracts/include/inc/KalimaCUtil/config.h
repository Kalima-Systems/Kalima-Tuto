...
#if __APPLE__
/**
 * @brief Load config for iOS App
 * 
 * @param LedgerName Not really useful
 * @param NODE_NAME Not really usefull
 * @param Privachain
 * @param SerialID 
 * @return Config* 
 */
Config *load_config_ios(char *LedgerName, char *NODE_NAME, char *NotariesList, char *SerialID);
#endif
